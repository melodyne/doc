window.SINGLE_TAB = "  ";
window.ImgCollapsed = "static/json_view/images/Collapsed.gif";
window.ImgExpanded = "static/json_view/images/Expanded.gif";
...
function EnsureIsPopulated(){
  ...
  if(!$id("Canvas").innerHTML && !!$id("RawJson").value) Process(jsonString);
