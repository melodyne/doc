 ...
 * UEditor编辑器通用上传类
 */
include "QiniuDriver.class.php";
class Uploader
{
    private $fileField;            //表单名称 文件域名
    private $file;                 //文件上传对象
    private $config;               //配置信息
     ...
     */
    public function __construct($config , $base64 = false )
    {
...
//        }
        ...
        //这里重写上传到七牛云
        $qiniu = new QiniuDriver($this->config);
        $file = $qiniu->getFileInfo();
